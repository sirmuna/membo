...
export default function LoginPage() {
  ...
  if (checkingSession) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#0D0A1A]">
        <div
          className="h-8 w-8 animate-spin rounded-full border-2 border-white/10 border-t-[#8B5CF6]"
